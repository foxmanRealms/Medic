...
(
	...
	// 복지사는 0
	public UserDTO(String user_id, String user_pw, char user_type, String user_company, String user_com_tel,
			String user_license, String user_name, String user_birthdate, char user_gender, String user_phone,
			String user_region) {
		super();
	...
	public UserDTO(String user_id, String user_pw, char user_type, String user_name, String user_birthdate,
			char user_gender, String user_phone, String user_region) {
		super();
		this.user_id = user_id;
		this.user_pw = user_pw;
		this.user_type = user_type;
