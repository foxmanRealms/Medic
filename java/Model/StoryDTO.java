...
public class StoryDTO {
	...
	*/
	...
	public StoryDTO(String story_title, String story_content, String story_file, int story_cnt, int story_like) {
		super();
	...
	public StoryDTO(String story_title, String story_content, String story_file, String story_joindate, String user_id,
			int story_cnt, int story_like) {
		super();
		this.story_title = story_title;
		this.story_content = story_content;
		this.story_file = story_file;
